...
Question::Question(int question_id, int asked_by_user_id, int asked_to_user_id, string question_text, bool is_answered): question_id(question_id),
asked_by_user_id(asked_by_user_id), asked_to_user_id(asked_to_user_id), question_text(""),is_answered(false){ }
